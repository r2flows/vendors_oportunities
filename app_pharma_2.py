...
# Mostrar productos en la intersección
    ...
    # Crear un conjunto de productos ganadores para este POS
        productos_ganadores = set(
            products_data['super_catalog_id'].unique()
        )

    # Filtrar semi_ganadores eliminando los que ya están en ganadores
    ...
    # Crear conjunto de productos semi ganadores
        productos_semi_ganadores = set(
            semi_ganadores_data['super_catalog_id'].unique()
        )

    # Filtrar medianamente ganadores
    ...
    # Mostrar semi ganadores filtrados
    ...
    # Mostrar medianamente ganadores filtrados
